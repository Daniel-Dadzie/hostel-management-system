...
export function MetricCard({ label, value, sub, icon: Icon, progress, featured = false }) {
  if (featured) {
    return (
      <div className="relative overflow-hidden rounded-[30px] bg-gradient-to-br from-[#0f6b46] via-[#19734f] to-[#0f5d3e] p-5 text-white shadow-[0_22px_46px_rgba(15,107,70,0.22)] dark:border dark:border-white/10 dark:bg-[linear-gradient(145deg,#3569d1_0%,#213760_42%,#1a1d22_100%)] dark:shadow-[0_28px_56px_rgba(0,0,0,0.46)]">
        <div className="absolute -right-10 -top-10 h-28 w-28 rounded-full bg-white/10 blur-2xl dark:bg-[#4d8fff]/24" />
        <div className="absolute inset-x-0 top-0 h-px bg-white/12 dark:bg-white/14" />
        <div className="relative z-10">
          <div className="mb-6 flex items-start justify-between gap-3">
            ...
            <div className="flex h-11 w-11 items-center justify-center rounded-full border border-white/18 bg-white/14 dark:border-white/12 dark:bg-white/10">
  ...
  return (
    <div className="card flex h-full flex-col justify-between rounded-[26px] p-5 shadow-[0_14px_30px_rgba(15,23,42,0.05)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.32)]">
      <div className="mb-6 flex items-start justify-between gap-3">
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-neutral-400 dark:text-white/36">
            {label}
          </p>
        ...
        <div className="flex h-11 w-11 items-center justify-center rounded-full border border-[#dde8df] bg-[#f5faf6] text-[#0f6b46] dark:border-white/10 dark:bg-[linear-gradient(180deg,#2b2e34_0%,#202227_100%)] dark:text-[#9fc3ff]">
          <Icon className="text-sm" />
        </div>
      </div>
      <p className="text-sm text-neutral-500 dark:text-white/56">{sub}</p>
      {progress !== null ? (
        <div className="mt-5">
